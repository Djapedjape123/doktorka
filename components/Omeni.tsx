        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="text-slate-600 mb-6 text-lg leading-relaxed">
              Rođena sam u Splitu, gde sam završila osnovnu školu, a gimnaziju &quot;Svetozar Marković&quot; i Medicinski fakultet, smer stomatologija, završila sam u Novom Sadu 2006. godine. Svoje znanje sam dalje proširila 2009. godine i dobila sertifikat "Menadžment u zdravstvu" na FON-u Univerziteta u Beogradu.
            </p>
