...
export default function VentuzePage() {
    ...
    const sveSlike = [
        "https://res.cloudinary.com/duomot4hp/image/upload/v1783196629/WhatsApp_Image_2026-07-04_at_22.20.52_1_z28lbh.jpg", // Slika 1 (Slajder)
        "https://res.cloudinary.com/duomot4hp/image/upload/v1783196639/WhatsApp_Image_2026-07-04_at_22.20.52_l0jned.jpg", // Slika 2 (Slajder)
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <FadeIn>
                        <div className="text-center mb-10">
                            <span className="text-teal-600 font-bold uppercase tracking-widest text-sm mb-2 block">Iskusite tretman</span>
                            <h2 className="text-3xl font-bold text-slate-900 mb-4">Pogledajte Ventuze u praksi</h2>
                            <p className="text-slate-600 max-w-2xl mx-auto">
                                Osetite ritam isceljenja: Kako se postavlja vakuum, pokreće cirkulacija i oslobađa napetost iz mišića.
                            </p>
                        </div>
